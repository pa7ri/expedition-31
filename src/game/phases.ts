...
export const PHASE_LABEL: Record<Phase, string> = {
  ...
  BAR_1: 'Burza #4 — Element Awakening',
  TRANSITION: 'Transition — the Portal',
  BAR_2: 'Bike Jesus — Elemental War',
...
export const PHASE_ANNOUNCEMENT: Record<Phase, { title: string; body: string } | null> = {
  SETUP: null,
  BAR_1: { title: 'THE ELEMENTS AWAKEN', body: 'Burza #4 begins. Seek energy, allies and artifacts.' },
  TRANSITION: { title: 'THE PORTAL OPENS', body: 'Find the explorers of your element and cross together.' },
  BAR_2: { title: 'THE ELEMENTAL WAR', body: 'Bike Jesus. All rewards grow. Legendary powers unlock.' },
 ...
 * LEGENDARY only unlocks in Bike Jesus; CHAOS is available once the game is live.
 */
